...
この仮定を満たす関数の場合は下の表のルールに従って各変数を頂点とし，これに特別な頂点 s と t を加えたグラフを構築することができます．このグラフの s-t cut は $E(\bold x)$ の解と 1 対 1 対応します．  
よって，グラフの minimum s-t cut がわかれば $E(\bold x)$ の最小解（=最適解）を求めることができます．
